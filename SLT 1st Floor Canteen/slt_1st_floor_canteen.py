#!/usr/bin/env python3
"""
SLT 1st Floor Canteen Modbus to InfluxDB Collector
...
def main():
    init_colors()
    print("SLT 1st Floor Canteen - Modbus to InfluxDB Collector")
    print("---------------------------------------------------")
    ...
    try:
        while True:
            ...
            if not block_a and not block_b:
                ...
                # Measurement: SLT 1st floor_canteen
                # Tags: device="SLT 1st floor", location="Canteen"
                point = Point("SLT 1st floor_canteen") \
                    .tag("device", "SLT 1st floor") \
